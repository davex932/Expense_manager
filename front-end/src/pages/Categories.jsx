...
const AddCategoryModal = ({ isOpen, onClose, onCategoryAdded, categoryToEdit }) => {
  ...
  const s = {
    ...
    label: { display: 'block', fontSize: '13px', fontWeight: '600', color: '#0f172a', marginBottom: '7px' },
    input: {
...
const Categories = () => {
  ...
  const s = {
    ...
    header: { display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '28px', gap: '16px', flexWrap: 'wrap' },
    ...
    card: { background: 'rgba(255, 255, 255, 0.88)', border: '1px solid rgba(226, 232, 240, 0.88)', borderRadius: '18px', boxShadow: '0 18px 45px rgba(15, 23, 42, 0.06)', padding: '20px', cursor: 'pointer', transition: 'box-shadow 0.2s', position: 'relative' },
    ...
    catName: { fontSize: '14px', fontWeight: '800', color: '#0f172a', margin: '0 0 2px 0' },
    ...
    totalLabel: { fontSize: '10px', fontWeight: '800', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.06em', margin: '0 0 4px 0' },
    totalAmount: { fontSize: '20px', fontWeight: '800', color: '#0f172a', margin: 0 },
    ...
    addCard: { border: '2px dashed #e2e8f0', borderRadius: '18px', padding: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: '#94a3b8', background: 'transparent', minHeight: '120px', transition: 'all 0.2s' },
